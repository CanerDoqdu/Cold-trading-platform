...
function buildCSP(nonce: string): string {
  const directives = [
    ...
    `connect-src 'self' wss://stream.binance.com wss://stream.binance.com:9443 wss://data-stream.binance.vision wss://streamer.cryptocompare.com https://api.coingecko.com https://pro-api.coingecko.com https://api.opensea.io https://min-api.cryptocompare.com https://openrouter.ai https://accounts.google.com`,
