...
const Navbar = () => {
  ...
  return (
    <div className="relative">
      <div className={`h-16 ${isNftRankingsPage ? "bg-transparent" : "bg-white dark:bg-BackgroundPrimary"} transition-all absolute top-0 left-0 right-0 z-20`}>
          ...
          {!user ? (
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="flex items-center gap-3 px-3 py-1.5 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800/50 transition-all"
              >
                ...
                <span className="text-gray-700 dark:text-gray-300 text-sm font-medium max-w-[150px] truncate hidden sm:block">
